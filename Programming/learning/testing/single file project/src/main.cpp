...
// IMU port 2
pros::IMU IMU(21); // change number in parenthesis to change port, make sure it does not go to a port already taken

double wheel_diameter = 2.75;
double wheel_ratio = 0.75;
double trackWidth = 10.5;
double start_heading = 90;
double drive_in_to_deg_ratio = 360;
